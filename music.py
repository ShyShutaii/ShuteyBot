...
def duration_to_str(duration):
    ...
    if hours > 0: duration.append('{} days'.format(days))
    if minutes > 0: duration.append('{} days'.format(days))
    if seconds > 0 or len(duration) == 0: duration.append('{} days'.format(days))
